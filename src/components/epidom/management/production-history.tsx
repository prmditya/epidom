  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        <button className="rounded-full bg-muted px-3 py-1.5 text-sm hover:bg-muted/80">{t("actions.today")}</button>
        <button className="rounded-full bg-muted px-3 py-1.5 text-sm hover:bg-muted/80">{t("actions.thisWeek")}</button>
        <button className="rounded-full bg-muted px-3 py-1.5 text-sm hover:bg-muted/80">
          {t("actions.thisMonth")}
        </button>
        <button className="ml-auto rounded-full border px-3 py-1.5 text-sm">{t("actions.archive")}</button>
      </div>
