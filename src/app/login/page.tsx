      ...
      <div className="flex items-center justify-center p-6 sm:p-8">
        <Card className="w-full max-w-md shadow-xl border-2">
          <CardHeader className="space-y-2 pb-6">
            <CardTitle className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">{t("auth.welcome")}</CardTitle>
          ...
          <CardContent>
            <form action={onSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input type="email" id="email" name="email" placeholder="you@bakery.com" required />
              </div>
              <div className="space-y-2">
            ...
            <p className="text-center text-sm text-muted-foreground">
              ...
              <Link href="/register" className="text-primary hover:text-primary/80 underline underline-offset-4 font-semibold transition-colors">
                {t("auth.register")}
              </Link>
            </p>
          </CardContent>
