"use client"
import { TrackingToggle } from "@/components/epidom/tracking-toggle"
...
const suppliers: Supplier[] = [
  {
    ...
    at: "10:05 AM",
    lines: [
      { id: "l1", product: "Butter", current: "10.22 Kg", min: "20.0 Kg", recommended: "20.5 Kg", toOrder: "10.3 Kg" },
      {
        id: "l2",
        product: "Chocolate",
        current: "9.15 Kg",
...
function Qty({ v, critical }: { v: string; critical?: boolean }) {
  return <span className={critical ? "text-red-600 font-medium" : "text-foreground"}>{v}</span>
}
