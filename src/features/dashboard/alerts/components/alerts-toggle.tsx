      ...
      {ALERT_SUPPLIERS.map((supplier, idx) => (
        ...
        >
          ...
          <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
            ...
            <span
              className={`inline-flex items-center justify-center self-start rounded-full px-3 py-1.5 text-xs font-semibold sm:self-center ${
                      ...
                      <div className="w-2/6 px-3">
                        <div className="bg-muted h-3 w-full rounded-full">
                          <div
                            ...
                            style={{
                              width: `${item.stockPercentage * 100}%`,
                            }}
                          />
                        </div>
                      </div>
