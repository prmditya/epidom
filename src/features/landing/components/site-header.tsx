      ...
      <nav aria-label="Main" className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-80 sm:w-96 p-0 flex flex-col animate-slide-up">
              <SheetTitle className="sr-only">{t("common.nav.navTitle")}</SheetTitle>
                  ...
                  <span className="sr-only">{t("common.brand")}</span>
                      ...
                      <SheetClose asChild>
                        <button
                          className="h-9 w-9 rounded-lg hover:bg-muted/50 transition-colors bg-muted/20 flex items-center justify-center"
