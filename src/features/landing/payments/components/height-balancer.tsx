...
export function HeightBalancer() {
  ...
  return (
    <>
      <div ref={leftRef} id="payment-form-container" className="lg:col-span-2 order-2 lg:order-1">
        {/* This will be replaced by the actual content */}
      </div>
      <div ref={rightRef} id="payment-sidebar-container" className="lg:col-span-1 order-1 lg:order-2">
        {/* This will be replaced by the actual content */}
      </div>
    </>
  );
